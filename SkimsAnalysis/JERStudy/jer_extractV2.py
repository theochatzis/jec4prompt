...
def extract_jer_profile(h2_mpfx, name_suffix, eta_min, eta_max, pt_bins):
    """
    ...
    h_prof_raw = h2_mpfx.ProfileY(f"h_prof_raw_{name_suffix}", b_low, b_high)
    ...
    if h2_mpfx.GetXaxis().GetXmin() < 0:
        ...
        h_neg = h2_mpfx.ProfileY(f"h_neg_{name_suffix}", b_neg_low, b_neg_high)
